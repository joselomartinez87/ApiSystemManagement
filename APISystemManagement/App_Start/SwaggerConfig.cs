                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "ManagerSystemAPI").Description("Web Api to get data about the differents system catalogs" + " " +
                        "\n\n### Authentication options\n### Bearer" +
                        "\n The supported authentication method is Berarer. For testing APIs via Swagger UI, please use a JWT generate by XXXXX")
                        .TermsOfService("Terms of service")
                            .Contact(x => x
                                .Name("Contact the developer")
                                .Url("jlmartineztobar@gmail.com"))
                            .License(x => x
                                .Name("Licencia")
                                .Url("jlmartineztobar@gmail.com"));
